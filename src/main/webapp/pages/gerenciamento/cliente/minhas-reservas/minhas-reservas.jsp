...
<head>
    ...
    <script src="/pages/gerenciamento/cliente/minhas-reservas/minhas-reservas.js" defer></script>
</head>
<body>
            ...
            <ul class="list_block">
                <c:forEach var="reserva" items="${reservas}">
                    <li class="list_item">
                        ...
                        <div class="btns_box">
                            <button type="button" class="btnCancelar" onclick="deletarReserva(this, '${reserva.id}')">Cancelar</button>
