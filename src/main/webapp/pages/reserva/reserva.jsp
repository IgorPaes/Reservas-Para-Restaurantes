        ...
        <main class="form_container">
            ...
            <div class="main_cont">
                    ...
                    <form class="form_reserve" id="userFormReserve" action="/InsertReserve" method="post">
                        <div class="fields_box">
                            ...
                            <div class="input_block">
                                ...
                                <div class="bg_input">
                                    <textarea name="comentario" id="comentario" placeholder="Digite aqui o comentário..." cols="30" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="buttons_box">
                    ...
                    <button type="button" class="btn_confirmar" onclick="insertReserve()">CONFIRMAR RESERVA</button>
                </div>
            </div>
        </main>
    </div>
